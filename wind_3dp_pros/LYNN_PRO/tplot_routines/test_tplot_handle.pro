...
;                                                                   [11/12/2015   v1.1.1]
;             4)  Fixed a bug with GIND keyword
;                                                                   [06/14/2016   v1.2.0]
;
;   NOTES:      
...
;    LAST MODIFIED:  06/14/2016   v1.2.0
...
IF (tpnms[0] NE '') THEN BEGIN
  ...
  IF (test[0]) THEN BEGIN
    FOR j=0L, nt[0] - 1L DO gind0[j] = (TOTAL(tpname[j] EQ tpnms) EQ 1)
;  LBW III  06/14/2016   v1.2.0
;    FOR j=0L, nt[0] - 1L DO gind0 = (TOTAL(tpname[j] EQ tpnms) EQ 1)
  ENDIF ELSE BEGIN
    FOR j=0L, nt[0] - 1L DO gind0[j] = (TOTAL(tpname[j] EQ tpind) EQ 1)
;  LBW III  06/14/2016   v1.2.0
