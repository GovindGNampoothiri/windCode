...
;
;   CHANGED:  1)  Removed use of SECONDS keyword in ctime.pro calls to avoid
;                   unnecessary (and truncated) rounding of actual time stamps
;                                                                   [08/26/2016   v1.1.0]
;
;   NOTES:      
...
;    LAST MODIFIED:  08/26/2016   v1.1.0
...
WHILE (true) DO BEGIN
  ...
  ;;----------------------------------------------------------------------------------
;  LBW III  08/26/2016   v1.1.0
;  ctime,x0,y0,z0,PROMPT=cur_prompt[0],/SECONDS,NPOINTS=1
  ctime,x0,y0,z0,PROMPT=cur_prompt[0],NPOINTS=1
  ;;--------------------------------------------------------------------------------------
...
;    ctime,x0,y0,z0,PROMPT=cur_prompt[0],/SECONDS,NPOINTS=num_data[0]
    ctime,x0,y0,z0,PROMPT=cur_prompt[0],NPOINTS=num_data[0]
    ;;  Check outputs
    nn     = num_data[0]
