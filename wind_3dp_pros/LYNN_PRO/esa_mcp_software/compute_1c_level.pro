...
;                               [Default = TRUE]
;
;   CHANGED:  1)  Fixed bug/error that occurs when CRATE keyword is set for Wind/3DP
;                   SST data sturctures
;                                                                   [02/05/2017   v1.0.1]
;
;   NOTES:      
...
;;  Force units to 'Counts' for 3DP SST Foil and Open structures
;;    --> CRATE and RATE not allowed in convert_sf_units.pro or convert_so_units.pro
CASE sn2char[0] OF
  'sf'  :  crate_on = 0b
  'so'  :  crate_on = 0b
  ELSE  :  ;;  Do nothing
