...
;                                                                  [08/06/2013   v2.0.6]
;             8)  Fixed a bug when user selects 'next' while viewing the zeroth
;                   distribution and the associated error message
;                                                                  [02/10/2017   v2.0.7]
;
;   NOTES:      
...
;    LAST MODIFIED:  02/10/2017   v2.0.7
