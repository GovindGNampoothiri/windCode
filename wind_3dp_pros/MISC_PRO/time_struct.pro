...
;                   input
;                                                                   [09/23/2015   v1.5.2]
;             9)  Updated to be in accordance with newest version of time_double.pro
;                   in SPEDAS IDL libraries [v2.0.0]
;                   A)  new keywords:  TFORMAT, TDIFF
;                   B)  now calls:  time_parse.pro
;                                                                   [06/13/2016   v1.6.0]
;            10)  Fixed a bug that occurred when a string type input was passed to this
;                   routine
;                                                                   [07/21/2016   v1.6.1]
;
;   NOTES:      
...
;    LAST MODIFIED:  07/21/2016   v1.6.1
